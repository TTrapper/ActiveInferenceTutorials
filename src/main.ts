...
import { PredatorPreySimulation } from './simulations/predator-prey';
  ...
  function switchSimulation(simulationType: SimulationType) {
    ...
    switch (simulationType) {
      case SimulationType.STATE_TRANSITION:
        ...
        break;
      case SimulationType.PREDATOR_PREY:
        currentSimulation = new PredatorPreySimulation(initialGridSize);
        break;
    }
